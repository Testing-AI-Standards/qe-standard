![Quality Check](https://github.com/Testing-AI-Standards/qe-standard/actions/workflows/standards-check.yml/badge.svg)
![Draft](https://img.shields.io/badge/Phase-Review-ffbf00)
...
The standard is located in [QE Standard.md](./service-manual-qe.md)

## 💬 Contributing Feedback

We welcome contributions and feedback from the community of practices and industry experts. You can use one of the options:

- Open an [Issue](https://github.com/Testing-AI-Standards/qe-standard/issues) to ask a question or suggest improvements > New Issue > Feedback on QE Standard > Fill the details
- Submit a Pull Request with proposed changes
- Use [Discussion](https://github.com/Testing-AI-Standards/qe-standard/discussions/1). Tag specific sections for clarification or refinement
